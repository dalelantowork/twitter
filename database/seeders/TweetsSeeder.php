...
class TweetsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('tweets')->insert([
            'name' => 'Dale Lanto',
            'handle' => '@dalelanto',
            'image' => 'https://scontent.fmnl17-3.fna.fbcdn.net/v/t39.30808-6/366949439_7237016289660269_7002010164376993459_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=52f669&_nc_eui2=AeGQuXFpQQzyhcsZQIGjCsZOVQTouexbJYhVBOi57FsliFGGEhnAOAUXaol8jLQCOmOLH46KdZsewXawBhNPVJXT&_nc_ohc=GEjC3zZqgxIAX8Vxhr9&_nc_ht=scontent.fmnl17-3.fna&_nc_e2o=s&oh=00_AfD23GeJ9nKu-YYvsJ3eHFwPIYtht0p_cH8rtkHa6Plakw&oe=64F8744A',
            'tweet' => 'Hello World Im Dale',
            'file' => '/videos/Sportsman.mp4',
            'is_video' => true,
            'comments' => '35',
            'retweets' => '54',
